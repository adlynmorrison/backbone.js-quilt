...
var Oemiv = (function($) {
    ...
    */
	...
	//thumbnail where thumbnail should be added
	var _$video_thumbnail_container;
	
	var _$video_display_title;
	var _$video_display_description;
	var _$video_display_embed;
    ...
    */
    return {
		...
		init: function(config) {
			...
			_$video_display_title = config.video_display_title;
			_$video_display_description = config.video_display_description;
			_$video_display_embed = config.video_display_embed;
        ...
        display_video: function(video) {
            ...
            _$video_display_title.text(video.title);

            // add the video description to the DOM
            _$video_display_description.text(video.description);
            ...
            _$video_display_embed.html(video.html);
        }
    };
})(window.jQuery);
